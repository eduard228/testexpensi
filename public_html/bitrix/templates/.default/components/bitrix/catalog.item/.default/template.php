...
if (isset($arResult['ITEM']))
{
    ...
    $itemInBasket = array_key_exists($actualItem['ID'],$arParams['BASKET_ITEMS']);
    $basketItem = $arParams['BASKET_ITEMS'][$actualItem['ID']];
	$curBasketMethod ='add2basket';
    if($itemInBasket){
        $curBasketMethod = 'delete';
    }
	?>
    <article id="<?=$areaId?>" class="catalog__item-wrapper">
	    <?
